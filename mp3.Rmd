...
When creating the graphic, we assumed that movies released more recently would not have as much sequel data, but in fact, although the segments for movies released in the 21st century are shorter, the total of follow up dots is about the same as other decades. The means that movies released more recently have about the same amount of follow ups as other decades, but the amount of follow ups was produced in less time. 
