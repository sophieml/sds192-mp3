...
ggplot(pop_seq, aes(x = original_year, y = title)) +
  ...
  geom_point(size = 3) +
  geom_point(data = subset(new_pop_seq, link_type_id == 2), aes(x = sequel_year, y = title), fill = 'white', shape = 21, size = 3) +
  geom_point(data = subset(new_pop_seq, link_type_id == 4), aes(x = sequel_year, y = title), fill = 'white', shape = 22, size = 2.9) +
  geom_point(data = subset(new_pop_seq, link_type_id == 12), aes(x = sequel_year, y = title),fill = 'white', shape = 24, size = 2.5) +
