...
When creating the graphic, we assumed that movies released more recently would not have as much data, but in fact, the segments for movies released in the 21st century are shorter, but the total of dots is about the same as other decades. The means that movies released more recently have about the same amount of follow ups as other decades, but the amount of follow ups was produced in less time. 
